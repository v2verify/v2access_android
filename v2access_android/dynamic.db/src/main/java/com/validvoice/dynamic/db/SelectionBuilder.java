...
/*
 * Modifications: BlueGreenApps
 * - Added whereIn convenience method
 * - Added whereNotIn convenience method
 */
...
public class SelectionBuilder {
    ...
    public SelectionBuilder whereIn(String field, String inField, String inTable,
                                       String where, String... selectionArgs) {
        return where(field + " in ( select " + inField + " from " + inTable + " where " + where + " )", selectionArgs);
    }

    public SelectionBuilder whereNotIn(String field, String notInField, String notInTable,
                                       String where, String... selectionArgs) {
