...
public class CameraSource {
    ...
    private Camera createCamera() {
        ...
        //   one for the nextQuestion pending frame to process immediately upon completing detection
     ...
     * (i.e., without unnecessary context switching or waiting on the nextQuestion frame).
     * <p/>
    ...
    private class FrameProcessingRunnable implements Runnable {
        ...
        void setNextFrame(byte[] data, Camera camera) {
            synchronized (mLock) {
                ...
                // Notify the processor thread if it is waiting on the nextQuestion frame (see below).
                mLock.notifyAll();
            }
        }
         ...
         * continuously.  The nextQuestion pending frame is either immediately available or hasn't been
         * received yet.  Once it is available, we transfer the frame info to local variables and
         * run detection on that frame.  It immediately loops back for the nextQuestion frame without
         * pausing.
         * <p/>
            ...
            while (true) {
                synchronized (mLock) {
                    while (mActive && (mPendingFrameData == null)) {
                        try {
                            // Wait for the nextQuestion frame to be received from the camera, since we
                            // don't have it yet.
                            mLock.wait();
                        } catch (InterruptedException e) {
